package com.nexify.book.demo.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.nexify.book.demo.repository")
...
public class DbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.nexify.book.demo.domain" });
